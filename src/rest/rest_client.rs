...
use super::enpoints::BinanceApiEndpoint;
...
impl RestClient {
    ...
    pub async fn get_signed<T: DeserializeOwned>(
        &self, endpoint: BinanceApiEndpoint, request: Option<String>,
    ) -> Result<T> {
    ...
    pub async fn post_signed<T: DeserializeOwned>(&self, endpoint: BinanceApiEndpoint, request: String) -> Result<T> {
    ...
    pub async fn get<T: DeserializeOwned>(&self, endpoint: BinanceApiEndpoint, request: Option<String>) -> Result<T> {
    ...
    pub async fn post<T: DeserializeOwned>(&self, endpoint: BinanceApiEndpoint) -> Result<T> {
    ...
    pub async fn put<T: DeserializeOwned>(&self, endpoint: BinanceApiEndpoint, listen_key: &str) -> Result<T> {
        let url: String = format!("{}{}", self.host, String::from(endpoint));
    ...
    pub async fn delete<T: DeserializeOwned>(&self, endpoint: BinanceApiEndpoint, listen_key: &str) -> Result<T> {
        let url: String = format!("{}{}", self.host, String::from(endpoint));
        let data: String = format!("listenKey={}", listen_key);
    ...
    fn sign_request(&self, endpoint: BinanceApiEndpoint, request: Option<String>) -> String {
        if let Some(request) = request {
            let mut signed_key =
